...
class Kama_Breadcrumbs {
	...
	function get_crumbs( $sep, $l10n, $args ){
		...
		$arg->sep = '<span class="bread-sep">'. $arg->sep .'</span>'; // дополним
		...
		if(1){
			...
			elseif( $mark === 'schema.org' ) $mark = array(
				...
				'linkpatt'   => '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a href="%s" itemprop="item" class="breadlink"><span itemprop="name">%s</span></a></span>',
				'sep_after'  => '',
			);
